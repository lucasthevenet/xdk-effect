...
export type BlockUsersDmsError = XOpError;
/** Block Users Dms */
export const blockUsersDms: API.OperationMethod<
  BlockUsersDmsRequest,
  BlockUsersDmsResponse,
  BlockUsersDmsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: BlockUsersDmsRequest,
  output: BlockUsersDmsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "blockUsersDms",
}));

export type CreateDirectMessagesByConversationIdError = XOpError;
/** Create Direct Messages by Conversation ID */
export const createDirectMessagesByConversationId: API.OperationMethod<
  CreateDirectMessagesByConversationIdRequest,
  CreateDirectMessagesByConversationIdResponse,
  CreateDirectMessagesByConversationIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateDirectMessagesByConversationIdRequest,
  output: CreateDirectMessagesByConversationIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createDirectMessagesByConversationId",
}));

export type CreateDirectMessagesByParticipantIdError = XOpError;
/** Create DM message by participant ID Sends a new direct message to a specific participant by their ID. */
export const createDirectMessagesByParticipantId: API.OperationMethod<
  CreateDirectMessagesByParticipantIdRequest,
  CreateDirectMessagesByParticipantIdResponse,
  CreateDirectMessagesByParticipantIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateDirectMessagesByParticipantIdRequest,
  output: CreateDirectMessagesByParticipantIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createDirectMessagesByParticipantId",
}));

export type CreateDirectMessagesConversationError = XOpError;
/** Create DM conversation Initiates a new direct message conversation with specified participants. */
export const createDirectMessagesConversation: API.OperationMethod<
  CreateDirectMessagesConversationRequest,
  CreateDirectMessagesConversationResponse,
  CreateDirectMessagesConversationError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateDirectMessagesConversationRequest,
  output: CreateDirectMessagesConversationResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createDirectMessagesConversation",
}));

export type DeleteDirectMessagesEventsError = XOpError;
/** Delete DM event Deletes a specific direct message event by its ID, if owned by the authenticated user. */
export const deleteDirectMessagesEvents: API.OperationMethod<
  DeleteDirectMessagesEventsRequest,
  DeleteDirectMessagesEventsResponse,
  DeleteDirectMessagesEventsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DeleteDirectMessagesEventsRequest,
  output: DeleteDirectMessagesEventsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "deleteDirectMessagesEvents",
}));

export type DmConversationsMediaDownloadError = XOpError;
/** Download DM Media Downloads media attached to a legacy Direct Message. The requesting user must be a participant in the conversation containing the specified DM event. The response body contains raw binary bytes. */
export const dmConversationsMediaDownload: API.OperationMethod<
  DmConversationsMediaDownloadRequest,
  DmConversationsMediaDownloadResponse,
  DmConversationsMediaDownloadError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "dmConversationsMediaDownload",
}));

export type GetDirectMessagesEventsError = XOpError;
/** Get Direct Messages Events */
export const getDirectMessagesEvents: API.OperationMethod<
  GetDirectMessagesEventsRequest,
  GetDirectMessagesEventsResponse,
  GetDirectMessagesEventsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetDirectMessagesEventsRequest,
  output: GetDirectMessagesEventsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getDirectMessagesEvents",
}));

export type GetDirectMessagesEventsByConversationIdError = XOpError;
/** Get Direct Messages Events by Conversation ID */
export const getDirectMessagesEventsByConversationId: API.OperationMethod<
  GetDirectMessagesEventsByConversationIdRequest,
  GetDirectMessagesEventsByConversationIdResponse,
  GetDirectMessagesEventsByConversationIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetDirectMessagesEventsByConversationIdRequest,
  output: GetDirectMessagesEventsByConversationIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getDirectMessagesEventsByConversationId",
}));

export type GetDirectMessagesEventsByIdError = XOpError;
/** Get Direct Messages Events by ID */
export const getDirectMessagesEventsById: API.OperationMethod<
  GetDirectMessagesEventsByIdRequest,
  GetDirectMessagesEventsByIdResponse,
  GetDirectMessagesEventsByIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetDirectMessagesEventsByIdRequest,
  output: GetDirectMessagesEventsByIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getDirectMessagesEventsById",
}));

export type GetDirectMessagesEventsByParticipantIdError = XOpError;
/** Get Direct Messages Events by Participant ID */
export const getDirectMessagesEventsByParticipantId: API.OperationMethod<
  GetDirectMessagesEventsByParticipantIdRequest,
  GetDirectMessagesEventsByParticipantIdResponse,
  GetDirectMessagesEventsByParticipantIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetDirectMessagesEventsByParticipantIdRequest,
  output: GetDirectMessagesEventsByParticipantIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getDirectMessagesEventsByParticipantId",
}));

export type UnblockUsersDmsError = XOpError;
/** Unblock Users Dms */
export const unblockUsersDms: API.OperationMethod<
  UnblockUsersDmsRequest,
  UnblockUsersDmsResponse,
  UnblockUsersDmsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UnblockUsersDmsRequest,
  output: UnblockUsersDmsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "unblockUsersDms",
}));
