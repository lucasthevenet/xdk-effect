...
export type GetPostsLikingUsersError = XOpError;
/** Get Posts Liking Users */
export const getPostsLikingUsers: API.OperationMethod<
  GetPostsLikingUsersRequest,
  GetPostsLikingUsersResponse,
  GetPostsLikingUsersError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsLikingUsersRequest,
  output: GetPostsLikingUsersResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsLikingUsers",
}));

export type LikePostError = XOpError;
/** Like Post */
export const likePost: API.OperationMethod<
  LikePostRequest,
  LikePostResponse,
  LikePostError,
  XOpContext
...
export type UnlikePostError = XOpError;
/** Unlike Post */
export const unlikePost: API.OperationMethod<
  UnlikePostRequest,
  UnlikePostResponse,
  UnlikePostError,
  XOpContext
