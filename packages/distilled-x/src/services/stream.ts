...
export type ActivityStreamError = XOpError;
/** Activity Stream Stream of X Activities */
export const activityStream: API.OperationMethod<
...
export type GetRuleCountsError = XOpError;
/** Get Rule Counts */
export const getRuleCounts: API.OperationMethod<
  GetRuleCountsRequest,
  GetRuleCountsResponse,
  GetRuleCountsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetRuleCountsRequest,
  output: GetRuleCountsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getRuleCounts",
}));

export type StreamLabelsComplianceError = XOpError;
/** Stream Post labels Streams all labeling events applied to Posts. */
export const streamLabelsCompliance: API.OperationMethod<
  StreamLabelsComplianceRequest,
  Stream.Stream<StreamLabelsComplianceResponse2, XOpError>,
  StreamLabelsComplianceError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamLabelsCompliance",
}));

export type StreamLikesComplianceError = XOpError;
/** Stream Likes compliance data Streams all compliance data related to Likes for Users. */
export const streamLikesCompliance: API.OperationMethod<
  StreamLikesComplianceRequest,
  Stream.Stream<StreamLikesComplianceResponse2, XOpError>,
  StreamLikesComplianceError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamLikesCompliance",
}));

export type StreamLikesFirehoseError = XOpError;
/** Stream all Likes Streams all public Likes in real-time. */
export const streamLikesFirehose: API.OperationMethod<
  StreamLikesFirehoseRequest,
  Stream.Stream<StreamLikesFirehoseResponse, XOpError>,
  StreamLikesFirehoseError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamLikesFirehose",
}));

export type StreamLikesSample10Error = XOpError;
/** Stream sampled Likes Streams a 10% sample of public Likes in real-time. */
export const streamLikesSample10: API.OperationMethod<
  StreamLikesSample10Request,
  Stream.Stream<StreamLikesSample10Response, XOpError>,
  StreamLikesSample10Error,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamLikesSample10",
}));

export type StreamPostsError = XOpError;
/** Stream filtered Posts Streams Posts in real-time matching the active rule set. */
export const streamPosts: API.OperationMethod<
  StreamPostsRequest,
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPosts",
}));

export type StreamPostsComplianceError = XOpError;
/** Stream Posts compliance data Streams all compliance data related to Posts. */
export const streamPostsCompliance: API.OperationMethod<
  StreamPostsComplianceRequest,
  Stream.Stream<StreamPostsComplianceResponse2, XOpError>,
  StreamPostsComplianceError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsCompliance",
}));

export type StreamPostsFirehoseError = XOpError;
/** Stream all Posts Streams all public Posts in real-time. */
export const streamPostsFirehose: API.OperationMethod<
  StreamPostsFirehoseRequest,
  Stream.Stream<StreamPostsFirehoseResponse, XOpError>,
  StreamPostsFirehoseError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsFirehose",
}));

export type StreamPostsFirehoseEnError = XOpError;
/** Stream English Posts Streams all public English-language Posts in real-time. */
export const streamPostsFirehoseEn: API.OperationMethod<
  StreamPostsFirehoseEnRequest,
  Stream.Stream<StreamPostsFirehoseEnResponse, XOpError>,
  StreamPostsFirehoseEnError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsFirehoseEn",
}));

export type StreamPostsFirehoseJaError = XOpError;
/** Stream Japanese Posts Streams all public Japanese-language Posts in real-time. */
export const streamPostsFirehoseJa: API.OperationMethod<
  StreamPostsFirehoseJaRequest,
  Stream.Stream<StreamPostsFirehoseJaResponse, XOpError>,
  StreamPostsFirehoseJaError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsFirehoseJa",
}));

export type StreamPostsFirehoseKoError = XOpError;
/** Stream Korean Posts Streams all public Korean-language Posts in real-time. */
export const streamPostsFirehoseKo: API.OperationMethod<
  StreamPostsFirehoseKoRequest,
  Stream.Stream<StreamPostsFirehoseKoResponse, XOpError>,
  StreamPostsFirehoseKoError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsFirehoseKo",
}));

export type StreamPostsFirehosePtError = XOpError;
/** Stream Portuguese Posts Streams all public Portuguese-language Posts in real-time. */
export const streamPostsFirehosePt: API.OperationMethod<
  StreamPostsFirehosePtRequest,
  Stream.Stream<StreamPostsFirehosePtResponse, XOpError>,
  StreamPostsFirehosePtError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsFirehosePt",
}));

export type StreamPostsSampleError = XOpError;
/** Stream sampled Posts Streams a 1% sample of public Posts in real-time. */
export const streamPostsSample: API.OperationMethod<
  StreamPostsSampleRequest,
  Stream.Stream<StreamPostsSampleResponse, XOpError>,
  StreamPostsSampleError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsSample",
}));

export type StreamPostsSample10Error = XOpError;
/** Stream 10% sampled Posts Streams a 10% sample of public Posts in real-time. */
export const streamPostsSample10: API.OperationMethod<
  StreamPostsSample10Request,
  Stream.Stream<StreamPostsSample10Response, XOpError>,
  StreamPostsSample10Error,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamPostsSample10",
}));

export type StreamUsersComplianceError = XOpError;
/** Stream Users compliance data Streams all compliance data related to Users. */
export const streamUsersCompliance: API.OperationMethod<
  StreamUsersComplianceRequest,
  Stream.Stream<StreamUsersComplianceResponse2, XOpError>,
  StreamUsersComplianceError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "streamUsersCompliance",
}));
