...
export const createCommunityNotes = /*@__PURE__*/ makeOperation<
  CreateCommunityNotesRequest,
  CreateCommunityNotesResponse
>(
  operations.createCommunityNotes,
  () => CreateCommunityNotesRequest,
  () => CreateCommunityNotesResponse,
);

export const deleteCommunityNotes = /*@__PURE__*/ makeOperation<
  DeleteCommunityNotesRequest,
  DeleteCommunityNotesResponse
>(
  operations.deleteCommunityNotes,
  () => DeleteCommunityNotesRequest,
  () => DeleteCommunityNotesResponse,
);

export const evaluateCommunityNotes = /*@__PURE__*/ makeOperation<
  EvaluateCommunityNotesRequest,
  EvaluateCommunityNotesResponse
>(
  operations.evaluateCommunityNotes,
  () => EvaluateCommunityNotesRequest,
  () => EvaluateCommunityNotesResponse,
);

export const searchCommunityNotesWritten = /*@__PURE__*/ makeOperation<
  SearchCommunityNotesWrittenRequest,
  SearchCommunityNotesWrittenResponse
>(
  operations.searchCommunityNotesWritten,
  () => SearchCommunityNotesWrittenRequest,
  () => SearchCommunityNotesWrittenResponse,
);

export const searchEligiblePosts = /*@__PURE__*/ makeOperation<
  SearchEligiblePostsRequest,
  SearchEligiblePostsResponse
>(
  operations.searchEligiblePosts,
  () => SearchEligiblePostsRequest,
  () => SearchEligiblePostsResponse,
);
