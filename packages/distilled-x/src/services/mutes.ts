...
export type UnmuteUserError = XOpError;
/** Unmute User Causes the authenticated user to unmute the target user. */
export const unmuteUser: API.OperationMethod<
  UnmuteUserRequest,
  UnmuteUserResponse,
  UnmuteUserError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UnmuteUserRequest,
  output: UnmuteUserResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "unmuteUser",
}));
