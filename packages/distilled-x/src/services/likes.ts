...
export type GetPostsLikingUsersRequestUserFieldsItem =
  | "confirmed_email"
  | "connection_status"
  | "created_at"
  | "description"
...
export type GetPostsLikingUsersRequestUserFieldsList = Array<
  GetPostsLikingUsersRequestUserFieldsItem | (string & {})
>;
export const GetPostsLikingUsersRequestUserFieldsList = /*@__PURE__*/ S.Array(
  GetPostsLikingUsersRequestUserFieldsItem,
) as any as S.Schema<GetPostsLikingUsersRequestUserFieldsList>;

export type GetPostsLikingUsersRequestExpansionsItem =
  | "affiliation"
  | "most_recent_post_id"
  | "pinned_post_id";
...
>;
export const GetPostsLikingUsersRequestExpansionsList = /*@__PURE__*/ S.Array(
  GetPostsLikingUsersRequestExpansionsItem,
) as any as S.Schema<GetPostsLikingUsersRequestExpansionsList>;

export type GetPostsLikingUsersRequestPostFieldsItem =
  | "article"
  | "article_title"
  | "attachments"
  | "card_uri"
...
export type GetPostsLikingUsersRequestPostFieldsList = Array<
  GetPostsLikingUsersRequestPostFieldsItem | (string & {})
>;
export const GetPostsLikingUsersRequestPostFieldsList = /*@__PURE__*/ S.Array(
  GetPostsLikingUsersRequestPostFieldsItem,
) as any as S.Schema<GetPostsLikingUsersRequestPostFieldsList>;

export interface GetPostsLikingUsersRequest {
  id: string;
  max_results?: number;
  /** A base32hex-encoded pagination token. */
  pagination_token?: string;
  /** A comma separated list of User fields to display. */
  user_fields?: GetPostsLikingUsersRequestUserFieldsList;
  /** A comma separated list of fields to expand. */
  expansions?: GetPostsLikingUsersRequestExpansionsList;
  /** A comma separated list of Post fields to display. */
  post_fields?: GetPostsLikingUsersRequestPostFieldsList;
}
export const GetPostsLikingUsersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type GetPostsLikingUsersResponseDataList = Array<User>;
export const GetPostsLikingUsersResponseDataList = /*@__PURE__*/ S.Array(
  User,
) as any as S.Schema<GetPostsLikingUsersResponseDataList>;
...
export type GetPostsLikingUsersResponseErrorsList = Array<Problem>;
export const GetPostsLikingUsersResponseErrorsList = /*@__PURE__*/ S.Array(
  Problem,
) as any as S.Schema<GetPostsLikingUsersResponseErrorsList>;
...
export interface GetPostsLikingUsersResponseMeta {
...
export const GetPostsLikingUsersResponseMeta = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
  ...
  identifier: "GetPostsLikingUsersResponseMeta",
}) as any as S.Schema<GetPostsLikingUsersResponseMeta>;

export interface GetPostsLikingUsersResponse {
  data?: GetPostsLikingUsersResponseDataList;
  errors?: GetPostsLikingUsersResponseErrorsList;
  includes?: Expansions;
  meta?: GetPostsLikingUsersResponseMeta;
}
export const GetPostsLikingUsersResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    data: S.optional(GetPostsLikingUsersResponseDataList),
    errors: S.optional(GetPostsLikingUsersResponseErrorsList),
    includes: S.optional(Expansions),
    meta: S.optional(GetPostsLikingUsersResponseMeta),
  }),
).annotate({
  identifier: "GetPostsLikingUsersResponse",
}) as any as S.Schema<GetPostsLikingUsersResponse>;

export interface LikePostRequest {
  id: string;
  tweet_id: string;
}
export const LikePostRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
    tweet_id: S.String,
...
export interface LikePostResponseData {
  /** Whether the User likes the Post. */
  liked: boolean;
}
export const LikePostResponseData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    liked: S.Boolean,
  }),
).annotate({
  identifier: "LikePostResponseData",
}) as any as S.Schema<LikePostResponseData>;

export type LikePostResponseErrorsList = Array<Problem>;
export const LikePostResponseErrorsList = /*@__PURE__*/ S.Array(
  Problem,
) as any as S.Schema<LikePostResponseErrorsList>;

export interface LikePostResponse {
  data?: LikePostResponseData;
  errors?: LikePostResponseErrorsList;
}
export const LikePostResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    data: S.optional(LikePostResponseData),
    errors: S.optional(LikePostResponseErrorsList),
  }),
).annotate({
  identifier: "LikePostResponse",
}) as any as S.Schema<LikePostResponse>;

export interface UnlikePostRequest {
  id: string;
  tweet_id: string;
}
export const UnlikePostRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
...
export const UnlikePostResponseData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    liked: S.Boolean,
  }),
).annotate({
  identifier: "UnlikePostResponseData",
}) as any as S.Schema<UnlikePostResponseData>;

export type UnlikePostResponseErrorsList = Array<Problem>;
export const UnlikePostResponseErrorsList = /*@__PURE__*/ S.Array(
  Problem,
) as any as S.Schema<UnlikePostResponseErrorsList>;

export interface UnlikePostResponse {
  data?: UnlikePostResponseData;
  errors?: UnlikePostResponseErrorsList;
}
export const UnlikePostResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    data: S.optional(UnlikePostResponseData),
    errors: S.optional(UnlikePostResponseErrorsList),
  }),
).annotate({
  identifier: "UnlikePostResponse",
}) as any as S.Schema<UnlikePostResponse>;

export const getPostsLikingUsers = /*@__PURE__*/ makeOperation<
  GetPostsLikingUsersRequest,
  GetPostsLikingUsersResponse
>(
  operations.getPostsLikingUsers,
  () => GetPostsLikingUsersRequest,
  () => GetPostsLikingUsersResponse,
);

export const likePost = /*@__PURE__*/ makeOperation<
  LikePostRequest,
  LikePostResponse
>(
  operations.likePost,
...
export const unlikePost = /*@__PURE__*/ makeOperation<
  UnlikePostRequest,
  UnlikePostResponse
>(
  operations.unlikePost,
  () => UnlikePostRequest,
  () => UnlikePostResponse,
);
