...
export type CreatePostsError = XOpError;
/** Create Posts */
export const createPosts: API.OperationMethod<
  CreatePostsRequest,
  CreatePostsResponse,
  CreatePostsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreatePostsRequest,
...
export type CreateUsersBookmarkError = XOpError;
/** Create Users Bookmark */
export const createUsersBookmark: API.OperationMethod<
  CreateUsersBookmarkRequest,
  CreateUsersBookmarkResponse,
  CreateUsersBookmarkError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateUsersBookmarkRequest,
  output: CreateUsersBookmarkResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createUsersBookmark",
}));

export type DeletePostsError = XOpError;
/** Delete Posts */
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "deletePosts",
}));

export type GetPostsAnalyticsError = XOpError;
/** Get Posts Analytics */
export const getPostsAnalytics: API.OperationMethod<
  GetPostsAnalyticsRequest,
  GetPostsAnalyticsResponse,
  GetPostsAnalyticsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsAnalyticsRequest,
  output: GetPostsAnalyticsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsAnalytics",
}));

export type GetPostsByIdError = XOpError;
/** Get Posts by ID */
export const getPostsById: API.OperationMethod<
  GetPostsByIdRequest,
  GetPostsByIdResponse,
  GetPostsByIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsByIdRequest,
  output: GetPostsByIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsById",
}));

export type GetPostsByIdsError = XOpError;
/** Get Posts by IDs */
export const getPostsByIds: API.OperationMethod<
  GetPostsByIdsRequest,
  GetPostsByIdsResponse,
  GetPostsByIdsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsByIdsRequest,
  output: GetPostsByIdsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsByIds",
}));

export type GetPostsQuotedPostsError = XOpError;
/** Get Posts Quoted Posts */
export const getPostsQuotedPosts: API.OperationMethod<
  GetPostsQuotedPostsRequest,
  GetPostsQuotedPostsResponse,
  GetPostsQuotedPostsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsQuotedPostsRequest,
  output: GetPostsQuotedPostsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsQuotedPosts",
}));

export type GetPostsRepostedByError = XOpError;
/** Get Posts Reposted by */
export const getPostsRepostedBy: API.OperationMethod<
  GetPostsRepostedByRequest,
  GetPostsRepostedByResponse,
  GetPostsRepostedByError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsRepostedByRequest,
  output: GetPostsRepostedByResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsRepostedBy",
}));

export type GetPostsRepostsError = XOpError;
/** Get Posts Reposts */
export const getPostsReposts: API.OperationMethod<
  GetPostsRepostsRequest,
  GetPostsRepostsResponse,
  GetPostsRepostsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPostsRepostsRequest,
  output: GetPostsRepostsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getPostsReposts",
}));

export type GetTrendsByWoeidError = XOpError;
/** Get Trends by Woeid */
export const getTrendsByWoeid: API.OperationMethod<
  GetTrendsByWoeidRequest,
  GetTrendsByWoeidResponse,
  GetTrendsByWoeidError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetTrendsByWoeidRequest,
  output: GetTrendsByWoeidResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getTrendsByWoeid",
}));

export type GetUsersBookmarkFoldersError = XOpError;
/** Get Users Bookmark Folders */
export const getUsersBookmarkFolders: API.OperationMethod<
  GetUsersBookmarkFoldersRequest,
  GetUsersBookmarkFoldersResponse,
  GetUsersBookmarkFoldersError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersBookmarkFoldersRequest,
  output: GetUsersBookmarkFoldersResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersBookmarkFolders",
}));

export type GetUsersBookmarksError = XOpError;
/** Get Users Bookmarks */
export const getUsersBookmarks: API.OperationMethod<
  GetUsersBookmarksRequest,
  GetUsersBookmarksResponse,
  GetUsersBookmarksError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersBookmarksRequest,
  output: GetUsersBookmarksResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersBookmarks",
}));

export type GetUsersBookmarksByFolderIdError = XOpError;
/** Get Users Bookmarks by Folder ID */
export const getUsersBookmarksByFolderId: API.OperationMethod<
  GetUsersBookmarksByFolderIdRequest,
  GetUsersBookmarksByFolderIdResponse,
  GetUsersBookmarksByFolderIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersBookmarksByFolderIdRequest,
  output: GetUsersBookmarksByFolderIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersBookmarksByFolderId",
}));

export type GetUsersLikedPostsError = XOpError;
/** Get Users Liked Posts */
export const getUsersLikedPosts: API.OperationMethod<
  GetUsersLikedPostsRequest,
  GetUsersLikedPostsResponse,
  GetUsersLikedPostsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersLikedPostsRequest,
  output: GetUsersLikedPostsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersLikedPosts",
}));

export type GetUsersMentionsError = XOpError;
/** Get Users Mentions When both are provided, `start_time` must be earlier than `end_time`. When both are provided, `since_id` must be less than `until_id`. */
export const getUsersMentions: API.OperationMethod<
  GetUsersMentionsRequest,
  GetUsersMentionsResponse,
  GetUsersMentionsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersMentionsRequest,
  output: GetUsersMentionsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersMentions",
}));

export type GetUsersPostsError = XOpError;
/** Get Users Posts When both are provided, `start_time` must be earlier than `end_time`. When both are provided, `since_id` must be less than `until_id`. */
export const getUsersPosts: API.OperationMethod<
  GetUsersPostsRequest,
  GetUsersPostsResponse,
  GetUsersPostsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersPostsRequest,
  output: GetUsersPostsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersPosts",
}));

export type GetUsersTimelineError = XOpError;
/** Get Users Timeline When both are provided, `start_time` must be earlier than `end_time`. When both are provided, `since_id` must be less than `until_id`. */
export const getUsersTimeline: API.OperationMethod<
  GetUsersTimelineRequest,
  GetUsersTimelineResponse,
  GetUsersTimelineError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersTimelineRequest,
  output: GetUsersTimelineResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersTimeline",
}));

export type HidePostsReplyError = XOpError;
/** Hide reply Hides or unhides a reply to a conversation owned by the authenticated user. */
export const hidePostsReply: API.OperationMethod<
  HidePostsReplyRequest,
  HidePostsReplyResponse,
  HidePostsReplyError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: HidePostsReplyRequest,
  output: HidePostsReplyResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "hidePostsReply",
}));

export type RepostPostError = XOpError;
/** Repost Post Causes the authenticated user to repost a specific Post by its ID. */
export const repostPost: API.OperationMethod<
  RepostPostRequest,
  RepostPostResponse,
  RepostPostError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: RepostPostRequest,
  output: RepostPostResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "repostPost",
}));

export type UnrepostPostError = XOpError;
/** Unrepost Post Causes the authenticated user to unrepost a specific Post by its ID. */
export const unrepostPost: API.OperationMethod<
  UnrepostPostRequest,
  UnrepostPostResponse,
  UnrepostPostError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UnrepostPostRequest,
  output: UnrepostPostResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "unrepostPost",
}));
