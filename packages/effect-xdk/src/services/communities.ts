...
export type GetCommunitiesByIdError = XOpError;
/** Get Communities by ID */
export const getCommunitiesById: API.OperationMethod<
  GetCommunitiesByIdRequest,
  GetCommunitiesByIdResponse,
  GetCommunitiesByIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetCommunitiesByIdRequest,
  output: GetCommunitiesByIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getCommunitiesById",
}));

export type SearchCommunitiesError = XOpError;
/** Search Communities */
export const searchCommunities: API.OperationMethod<
  SearchCommunitiesRequest,
  SearchCommunitiesResponse,
  SearchCommunitiesError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: SearchCommunitiesRequest,
