...
export type AppendMediaUploadError = XOpError;
/** Append Media Upload */
export const appendMediaUpload: API.OperationMethod<
  AppendMediaUploadRequest,
  AppendMediaUploadResponse,
  AppendMediaUploadError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AppendMediaUploadRequest,
  output: AppendMediaUploadResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "appendMediaUpload",
}));

export type CreateMediaMetadataError = XOpError;
/** Create Media metadata Creates metadata for a Media file. */
export const createMediaMetadata: API.OperationMethod<
  CreateMediaMetadataRequest,
  CreateMediaMetadataResponse,
  CreateMediaMetadataError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateMediaMetadataRequest,
  output: CreateMediaMetadataResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createMediaMetadata",
}));

export type CreateMediaSubtitlesError = XOpError;
/** Create Media subtitles Creates subtitles for a specific Media file. */
export const createMediaSubtitles: API.OperationMethod<
  CreateMediaSubtitlesRequest,
  CreateMediaSubtitlesResponse,
  CreateMediaSubtitlesError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateMediaSubtitlesRequest,
  output: CreateMediaSubtitlesResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createMediaSubtitles",
}));

export type DeleteMediaSubtitlesError = XOpError;
/** Delete Media subtitles Deletes subtitles for a specific Media file. */
export const deleteMediaSubtitles: API.OperationMethod<
  DeleteMediaSubtitlesRequest,
  DeleteMediaSubtitlesResponse,
  DeleteMediaSubtitlesError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DeleteMediaSubtitlesRequest,
  output: DeleteMediaSubtitlesResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "deleteMediaSubtitles",
}));

export type FinalizeMediaUploadError = XOpError;
/** Finalize Media upload Finalizes a Media upload request. */
export const finalizeMediaUpload: API.OperationMethod<
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "finalizeMediaUpload",
}));

export type GetMediaAnalyticsError = XOpError;
/** Get Media analytics */
export const getMediaAnalytics: API.OperationMethod<
  GetMediaAnalyticsRequest,
  GetMediaAnalyticsResponse,
  GetMediaAnalyticsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetMediaAnalyticsRequest,
  output: GetMediaAnalyticsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getMediaAnalytics",
}));

export type GetMediaByMediaKeyError = XOpError;
/** Get Media by media key */
export const getMediaByMediaKey: API.OperationMethod<
  GetMediaByMediaKeyRequest,
  GetMediaByMediaKeyResponse,
  GetMediaByMediaKeyError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetMediaByMediaKeyRequest,
  output: GetMediaByMediaKeyResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getMediaByMediaKey",
}));

export type GetMediaByMediaKeysError = XOpError;
/** Get Media by media keys */
export const getMediaByMediaKeys: API.OperationMethod<
  GetMediaByMediaKeysRequest,
  GetMediaByMediaKeysResponse,
  GetMediaByMediaKeysError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetMediaByMediaKeysRequest,
  output: GetMediaByMediaKeysResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getMediaByMediaKeys",
}));

export type GetMediaUploadStatusError = XOpError;
/** Get Media upload status Retrieves the status of a Media upload by its ID. */
export const getMediaUploadStatus: API.OperationMethod<
  GetMediaUploadStatusRequest,
  GetMediaUploadStatusResponse,
  GetMediaUploadStatusError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetMediaUploadStatusRequest,
  output: GetMediaUploadStatusResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getMediaUploadStatus",
}));

export type InitializeMediaUploadError = XOpError;
/** Initialize media upload Initializes a media upload. */
export const initializeMediaUpload: API.OperationMethod<
  InitializeMediaUploadRequest,
  InitializeMediaUploadResponse,
  InitializeMediaUploadError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: InitializeMediaUploadRequest,
  output: InitializeMediaUploadResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "initializeMediaUpload",
}));

export type MediaUploadError = XOpError;
/** Upload media Uploads a media file for use in posts or other content. */
export const mediaUpload: API.OperationMethod<
  MediaUploadRequest,
  MediaUploadResponse,
  MediaUploadError,
  XOpContext
