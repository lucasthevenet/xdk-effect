...
export type AddChatGroupMembersError = XOpError;
/** Add members to a Chat group conversation Adds one or more members to an existing encrypted Chat group conversation, rotating the conversation key. */
export const addChatGroupMembers: API.OperationMethod<
  AddChatGroupMembersRequest,
  AddChatGroupMembersResponse,
  AddChatGroupMembersError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AddChatGroupMembersRequest,
  output: AddChatGroupMembersResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "addChatGroupMembers",
}));

export type AddConversationKeysError = XOpError;
/** Add Conversation Keys Adds (initializes or rotates) the encryption keys for a Chat conversation. Call this before sending messages in a new 1:1 conversation, and again with a newer key version to rotate the conversation key. For 1:1 conversations, provide the recipient's user ID as the conversation id; the server constructs the canonical conversation ID from the authenticated user and recipient. The request body must contain the conversation key version and participant keys (the conversation key encrypted for each participant using their public key). */
export const addConversationKeys: API.OperationMethod<
  AddConversationKeysRequest,
  AddConversationKeysResponse,
  AddConversationKeysError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AddConversationKeysRequest,
  output: AddConversationKeysResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "addConversationKeys",
}));

export type AddUserPublicKeyError = XOpError;
/** Add public key Registers a user's public key for X Chat encryption. */
export const addUserPublicKey: API.OperationMethod<
  AddUserPublicKeyRequest,
  AddUserPublicKeyResponse,
  AddUserPublicKeyError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AddUserPublicKeyRequest,
  output: AddUserPublicKeyResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "addUserPublicKey",
}));

export type ChatMediaDownloadError = XOpError;
/** Download Chat Media Downloads encrypted media bytes from an XChat conversation. The response body contains raw binary bytes. */
export const chatMediaDownload: API.OperationMethod<
  ChatMediaDownloadRequest,
  ChatMediaDownloadResponse,
  ChatMediaDownloadError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  ...
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "chatMediaDownload",
}));

export type ChatMediaUploadAppendError = XOpError;
/** Append Chat Media Upload Appends media data to an XChat upload session. */
export const chatMediaUploadAppend: API.OperationMethod<
  ChatMediaUploadAppendRequest,
  ChatMediaUploadAppendResponse,
  ChatMediaUploadAppendError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ChatMediaUploadAppendRequest,
  output: ChatMediaUploadAppendResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "chatMediaUploadAppend",
}));

export type ChatMediaUploadFinalizeError = XOpError;
/** Finalize Chat Media Upload Finalizes an XChat media upload session. */
export const chatMediaUploadFinalize: API.OperationMethod<
  ChatMediaUploadFinalizeRequest,
  ChatMediaUploadFinalizeResponse,
  ChatMediaUploadFinalizeError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ChatMediaUploadFinalizeRequest,
  output: ChatMediaUploadFinalizeResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "chatMediaUploadFinalize",
}));

export type ChatMediaUploadInitializeError = XOpError;
/** Initialize Chat Media Upload Initializes an XChat media upload session. */
export const chatMediaUploadInitialize: API.OperationMethod<
  ChatMediaUploadInitializeRequest,
  ChatMediaUploadInitializeResponse,
  ChatMediaUploadInitializeError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ChatMediaUploadInitializeRequest,
  output: ChatMediaUploadInitializeResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "chatMediaUploadInitialize",
}));

export type CreateChatConversationError = XOpError;
/** Create Chat Group Conversation Creates a new encrypted Chat group conversation on behalf of the authenticated user. */
export const createChatConversation: API.OperationMethod<
  CreateChatConversationRequest,
  CreateChatConversationResponse,
  CreateChatConversationError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateChatConversationRequest,
...
export type GetChatConversationError = XOpError;
/** Get Chat Conversation Returns metadata for a Chat conversation including type, muted status, and group details. Use chat_conversation.fields to select which fields are returned. Use expansions to hydrate member, admin, or participant user objects. Use user.fields to control which profile fields are returned for expanded users. */
export const getChatConversation: API.OperationMethod<
  GetChatConversationRequest,
  GetChatConversationResponse,
  GetChatConversationError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetChatConversationRequest,
  output: GetChatConversationResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getChatConversation",
}));

export type GetChatConversationEventsError = XOpError;
/** Get Chat Conversation Events Retrieves messages and key change events for a specific Chat conversation with pagination support. For 1:1 conversations, provide the recipient's user ID; the server constructs the canonical conversation ID from the authenticated user and recipient. */
export const getChatConversationEvents: API.OperationMethod<
  GetChatConversationEventsRequest,
  GetChatConversationEventsResponse,
  GetChatConversationEventsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetChatConversationEventsRequest,
  output: GetChatConversationEventsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getChatConversationEvents",
}));

export type GetChatConversationsError = XOpError;
/** Get Chat Conversations Retrieves a list of Chat conversations for the authenticated user's inbox. */
export const getChatConversations: API.OperationMethod<
  GetChatConversationsRequest,
  GetChatConversationsResponse,
  GetChatConversationsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetChatConversationsRequest,
  output: GetChatConversationsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getChatConversations",
}));

export type GetUsersPublicKeyError = XOpError;
/** Get public keys Returns a user's registered public keys for X Chat encryption. */
export const getUsersPublicKey: API.OperationMethod<
  GetUsersPublicKeyRequest,
  GetUsersPublicKeyResponse,
  GetUsersPublicKeyError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersPublicKeyRequest,
  output: GetUsersPublicKeyResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersPublicKey",
}));

export type GetUsersPublicKeysError = XOpError;
/** Get public keys Returns registered public keys for X Chat encryption for the specified users. */
export const getUsersPublicKeys: API.OperationMethod<
  GetUsersPublicKeysRequest,
  GetUsersPublicKeysResponse,
  GetUsersPublicKeysError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersPublicKeysRequest,
  output: GetUsersPublicKeysResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersPublicKeys",
}));

export type InitializeChatGroupError = XOpError;
/** Initialize Chat Group Initializes a new Chat group conversation and returns a unique conversation ID. Use the returned conversation_id in a subsequent POST /chat/conversations/group call to fully create and configure the group. */
export const initializeChatGroup: API.OperationMethod<
  InitializeChatGroupRequest,
  InitializeChatGroupResponse,
  InitializeChatGroupError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: InitializeChatGroupRequest,
  output: InitializeChatGroupResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "initializeChatGroup",
}));

export type MarkChatConversationReadError = XOpError;
/** Mark Conversation as Read Marks a specific Chat conversation as read on behalf of the authenticated user. For 1:1 conversations, provide the recipient's user ID; the server constructs the canonical conversation ID from the authenticated user and recipient. */
export const markChatConversationRead: API.OperationMethod<
  MarkChatConversationReadRequest,
  MarkChatConversationReadResponse,
  MarkChatConversationReadError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: MarkChatConversationReadRequest,
  output: MarkChatConversationReadResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "markChatConversationRead",
}));

export type SendChatMessageError = XOpError;
/** Send Chat Message Sends an encrypted message to a specific Chat conversation. For 1:1 conversations, provide the recipient's user ID; the server constructs the canonical conversation ID from the authenticated user and recipient. */
export const sendChatMessage: API.OperationMethod<
...
export type SendChatTypingIndicatorError = XOpError;
/** Send Typing Indicator Sends a typing indicator to a specific Chat conversation on behalf of the authenticated user. For 1:1 conversations, provide the recipient's user ID; the server constructs the canonical conversation ID from the authenticated user and recipient. */
export const sendChatTypingIndicator: API.OperationMethod<
  SendChatTypingIndicatorRequest,
  SendChatTypingIndicatorResponse,
  SendChatTypingIndicatorError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: SendChatTypingIndicatorRequest,
  output: SendChatTypingIndicatorResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "sendChatTypingIndicator",
}));
