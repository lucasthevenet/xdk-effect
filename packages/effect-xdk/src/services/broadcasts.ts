...
export type CreateScheduledBroadcastError = XOpError;
/** Create a scheduled broadcast Schedules a one-off or recurring broadcast for the authenticated user. A `source_id` (ingest) is required at create time. */
export const createScheduledBroadcast: API.OperationMethod<
  CreateScheduledBroadcastRequest,
  CreateScheduledBroadcastResponse,
  CreateScheduledBroadcastError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateScheduledBroadcastRequest,
  output: CreateScheduledBroadcastResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createScheduledBroadcast",
}));

export type DeleteScheduledBroadcastError = XOpError;
/** Delete a scheduled broadcast Deletes a scheduled broadcast by its alphanumeric UBS broadcast id. */
export const deleteScheduledBroadcast: API.OperationMethod<
  DeleteScheduledBroadcastRequest,
  DeleteScheduledBroadcastResponse,
  DeleteScheduledBroadcastError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DeleteScheduledBroadcastRequest,
  output: DeleteScheduledBroadcastResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "deleteScheduledBroadcast",
}));

export type GetScheduledBroadcastError = XOpError;
/** Get a scheduled broadcast Returns a single scheduled broadcast by its alphanumeric UBS broadcast id. */
export const getScheduledBroadcast: API.OperationMethod<
  GetScheduledBroadcastRequest,
  GetScheduledBroadcastResponse,
  GetScheduledBroadcastError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetScheduledBroadcastRequest,
  output: GetScheduledBroadcastResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getScheduledBroadcast",
}));

export type GoLiveScheduledBroadcastError = XOpError;
/** Go live on a scheduled broadcast Publishes a schedule that was created or updated with `manual_publish: true`. Without that flag the coordinator auto-publishes at start and this call is rejected. */
export const goLiveScheduledBroadcast: API.OperationMethod<
  GoLiveScheduledBroadcastRequest,
  GoLiveScheduledBroadcastResponse,
  GoLiveScheduledBroadcastError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GoLiveScheduledBroadcastRequest,
  output: GoLiveScheduledBroadcastResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "goLiveScheduledBroadcast",
}));

export type ListScheduledBroadcastsError = XOpError;
/** List scheduled broadcasts Returns scheduled broadcasts owned by the authenticated user. */
export const listScheduledBroadcasts: API.OperationMethod<
  ListScheduledBroadcastsRequest,
  ListScheduledBroadcastsResponse,
  ListScheduledBroadcastsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListScheduledBroadcastsRequest,
  output: ListScheduledBroadcastsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "listScheduledBroadcasts",
}));

export type SendBroadcastChatError = XOpError;
/** Send a chat message to a live broadcast Posts a chat message to a running broadcast, attributed to the authenticated user. */
export const sendBroadcastChat: API.OperationMethod<
  SendBroadcastChatRequest,
  SendBroadcastChatResponse,
  SendBroadcastChatError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: SendBroadcastChatRequest,
  output: SendBroadcastChatResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "sendBroadcastChat",
}));

export type UpdateScheduledBroadcastError = XOpError;
/** Update a scheduled broadcast Fully replaces schedule fields for a broadcast. Path `:id` is the UBS broadcast id; the body must include `scheduled_broadcast_id` and re-send any fields that should be kept. */
export const updateScheduledBroadcast: API.OperationMethod<
  UpdateScheduledBroadcastRequest,
  UpdateScheduledBroadcastResponse,
  UpdateScheduledBroadcastError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateScheduledBroadcastRequest,
  output: UpdateScheduledBroadcastResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "updateScheduledBroadcast",
}));
