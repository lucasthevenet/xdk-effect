...
export const FollowUserRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    .pipe(T.Http({ method: "POST", uri: "/2/users/{id}/following", code: 200 }))
    .pipe(T.Security(["oauth2", "oauth1"]))
    .pipe(T.RequestBody(true)),
).annotate({
...
export const GetUsersAffiliatesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    user_fields: S.optional(
      GetUsersAffiliatesRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersAffiliatesRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersAffiliatesRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
  })
    .pipe(T.Http({ method: "GET", uri: "/2/users/{id}/affiliates", code: 200 }))
...
export const GetUsersBlockingRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    user_fields: S.optional(
      GetUsersBlockingRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersBlockingRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersBlockingRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersByIdRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
    user_fields: S.optional(
      GetUsersByIdRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersByIdRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersByIdRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersByIdsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ids: GetUsersByIdsRequestIdsList.pipe(T.Query(), T.CsvQuery(true)),
    user_fields: S.optional(
      GetUsersByIdsRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersByIdsRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersByIdsRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersByUsernameRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    user_fields: S.optional(
      GetUsersByUsernameRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersByUsernameRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersByUsernameRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersByUsernamesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    usernames: GetUsersByUsernamesRequestUsernamesList.pipe(
      T.Query(),
      T.CsvQuery(true),
    ),
    user_fields: S.optional(
      GetUsersByUsernamesRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersByUsernamesRequestExpansionsList.pipe(
        T.Query(),
        T.CsvQuery(true),
      ),
    ),
    post_fields: S.optional(
      GetUsersByUsernamesRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersFollowedListsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    list_fields: S.optional(
      GetUsersFollowedListsRequestListFieldsList.pipe(
        T.Query("list.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersFollowedListsRequestExpansionsList.pipe(
        T.Query(),
        T.CsvQuery(true),
      ),
    ),
    user_fields: S.optional(
      GetUsersFollowedListsRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersFollowersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    user_fields: S.optional(
      GetUsersFollowersRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersFollowersRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersFollowersRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersFollowingRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    user_fields: S.optional(
      GetUsersFollowingRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersFollowingRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersFollowingRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersListMembershipsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    list_fields: S.optional(
      GetUsersListMembershipsRequestListFieldsList.pipe(
        T.Query("list.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersListMembershipsRequestExpansionsList.pipe(
        T.Query(),
        T.CsvQuery(true),
      ),
    ),
    user_fields: S.optional(
      GetUsersListMembershipsRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    ...
    .pipe(
      T.Http({
        method: "GET",
        uri: "/2/users/{id}/list_memberships",
        code: 200,
      }),
    )
    .pipe(T.Security(["oauth2", "oauth1", "app"])),
...
export const GetUsersMeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    user_fields: S.optional(
      GetUsersMeRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersMeRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersMeRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersMutingRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    user_fields: S.optional(
      GetUsersMutingRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersMutingRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      GetUsersMutingRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersOwnedListsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    list_fields: S.optional(
      GetUsersOwnedListsRequestListFieldsList.pipe(
        T.Query("list.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersOwnedListsRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    user_fields: S.optional(
      GetUsersOwnedListsRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersPinnedListsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
    list_fields: S.optional(
      GetUsersPinnedListsRequestListFieldsList.pipe(
        T.Query("list.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersPinnedListsRequestExpansionsList.pipe(
        T.Query(),
        T.CsvQuery(true),
      ),
    ),
    user_fields: S.optional(
      GetUsersPinnedListsRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export const GetUsersRepostsOfMeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pagination_token: S.optional(S.String.pipe(T.Query())),
    post_fields: S.optional(
      GetUsersRepostsOfMeRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      GetUsersRepostsOfMeRequestExpansionsList.pipe(
        T.Query(),
        T.CsvQuery(true),
      ),
    ),
    user_fields: S.optional(
      GetUsersRepostsOfMeRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    media_fields: S.optional(
      GetUsersRepostsOfMeRequestMediaFieldsList.pipe(
        T.Query("media.fields"),
        T.CsvQuery(true),
      ),
    ),
    poll_fields: S.optional(
      GetUsersRepostsOfMeRequestPollFieldsList.pipe(
        T.Query("poll.fields"),
        T.CsvQuery(true),
      ),
    ),
    place_fields: S.optional(
      GetUsersRepostsOfMeRequestPlaceFieldsList.pipe(
...
export const SearchUsersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    user_fields: S.optional(
      SearchUsersRequestUserFieldsList.pipe(
        T.Query("user.fields"),
        T.CsvQuery(true),
      ),
    ),
    expansions: S.optional(
      SearchUsersRequestExpansionsList.pipe(T.Query(), T.CsvQuery(true)),
    ),
    post_fields: S.optional(
      SearchUsersRequestPostFieldsList.pipe(
        T.Query("post.fields"),
        T.CsvQuery(true),
      ),
    ),
...
export type FollowListError = XOpError;
/** Follow List */
export const followList: API.OperationMethod<
  FollowListRequest,
  FollowListResponse,
  FollowListError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: FollowListRequest,
  output: FollowListResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "followList",
}));

export type FollowUserError = XOpError;
/** Follow User */
export const followUser: API.OperationMethod<
  FollowUserRequest,
  FollowUserResponse,
  FollowUserError,
  XOpContext
...
export type GetUsersAffiliatesError = XOpError;
/** Get Users Affiliates */
export const getUsersAffiliates: API.OperationMethod<
  GetUsersAffiliatesRequest,
  GetUsersAffiliatesResponse,
  GetUsersAffiliatesError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersAffiliatesRequest,
  output: GetUsersAffiliatesResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersAffiliates",
}));

export type GetUsersBlockingError = XOpError;
/** Get Users Blocking */
export const getUsersBlocking: API.OperationMethod<
  GetUsersBlockingRequest,
  GetUsersBlockingResponse,
  GetUsersBlockingError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersBlockingRequest,
  output: GetUsersBlockingResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersBlocking",
}));

export type GetUsersByIdError = XOpError;
/** Get Users by ID */
export const getUsersById: API.OperationMethod<
  GetUsersByIdRequest,
  GetUsersByIdResponse,
  GetUsersByIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersByIdRequest,
...
export type GetUsersByIdsError = XOpError;
/** Get Users by IDs */
export const getUsersByIds: API.OperationMethod<
  GetUsersByIdsRequest,
  GetUsersByIdsResponse,
  GetUsersByIdsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersByIdsRequest,
...
export type GetUsersByUsernameError = XOpError;
/** Get Users by Username */
export const getUsersByUsername: API.OperationMethod<
  GetUsersByUsernameRequest,
  GetUsersByUsernameResponse,
  GetUsersByUsernameError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersByUsernameRequest,
  output: GetUsersByUsernameResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersByUsername",
}));

export type GetUsersByUsernamesError = XOpError;
/** Get Users by Usernames */
export const getUsersByUsernames: API.OperationMethod<
  GetUsersByUsernamesRequest,
  GetUsersByUsernamesResponse,
  GetUsersByUsernamesError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersByUsernamesRequest,
  output: GetUsersByUsernamesResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersByUsernames",
}));

export type GetUsersFollowedListsError = XOpError;
/** Get Users Followed Lists */
export const getUsersFollowedLists: API.OperationMethod<
  GetUsersFollowedListsRequest,
  GetUsersFollowedListsResponse,
  GetUsersFollowedListsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersFollowedListsRequest,
  output: GetUsersFollowedListsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersFollowedLists",
}));

export type GetUsersFollowersError = XOpError;
/** Get Users Followers */
export const getUsersFollowers: API.OperationMethod<
  GetUsersFollowersRequest,
  GetUsersFollowersResponse,
  GetUsersFollowersError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersFollowersRequest,
  output: GetUsersFollowersResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersFollowers",
}));

export type GetUsersFollowingError = XOpError;
/** Get Users Following */
export const getUsersFollowing: API.OperationMethod<
  GetUsersFollowingRequest,
  GetUsersFollowingResponse,
  GetUsersFollowingError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersFollowingRequest,
  output: GetUsersFollowingResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersFollowing",
}));

export type GetUsersListMembershipsError = XOpError;
/** Get Users List Memberships */
export const getUsersListMemberships: API.OperationMethod<
  GetUsersListMembershipsRequest,
  GetUsersListMembershipsResponse,
  GetUsersListMembershipsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersListMembershipsRequest,
  output: GetUsersListMembershipsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersListMemberships",
}));

export type GetUsersMeError = XOpError;
/** Get Users Me */
export const getUsersMe: API.OperationMethod<
  GetUsersMeRequest,
  GetUsersMeResponse,
  GetUsersMeError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersMeRequest,
...
export type GetUsersMutingError = XOpError;
/** Get Users Muting */
export const getUsersMuting: API.OperationMethod<
  GetUsersMutingRequest,
  GetUsersMutingResponse,
  GetUsersMutingError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersMutingRequest,
  output: GetUsersMutingResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersMuting",
}));

export type GetUsersOwnedListsError = XOpError;
/** Get Users Owned Lists */
export const getUsersOwnedLists: API.OperationMethod<
  GetUsersOwnedListsRequest,
  GetUsersOwnedListsResponse,
  GetUsersOwnedListsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersOwnedListsRequest,
  output: GetUsersOwnedListsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersOwnedLists",
}));

export type GetUsersPinnedListsError = XOpError;
/** Get Users Pinned Lists */
export const getUsersPinnedLists: API.OperationMethod<
  GetUsersPinnedListsRequest,
  GetUsersPinnedListsResponse,
  GetUsersPinnedListsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersPinnedListsRequest,
  output: GetUsersPinnedListsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersPinnedLists",
}));

export type GetUsersRepostsOfMeError = XOpError;
/** Get Users Reposts of Me */
export const getUsersRepostsOfMe: API.OperationMethod<
  GetUsersRepostsOfMeRequest,
  GetUsersRepostsOfMeResponse,
  GetUsersRepostsOfMeError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetUsersRepostsOfMeRequest,
  output: GetUsersRepostsOfMeResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getUsersRepostsOfMe",
}));

export type MuteUserError = XOpError;
/** Mute User */
export const muteUser: API.OperationMethod<
  MuteUserRequest,
  MuteUserResponse,
  MuteUserError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: MuteUserRequest,
...
export type SearchUsersError = XOpError;
/** Search Users */
...
export type UnfollowUserError = XOpError;
/** Unfollow User Causes the authenticated user to unfollow a specific user by their ID. */
export const unfollowUser: API.OperationMethod<
  UnfollowUserRequest,
