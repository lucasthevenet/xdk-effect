...
export type AddListsMemberError = XOpError;
/** Add Lists Member */
export const addListsMember: API.OperationMethod<
  AddListsMemberRequest,
  AddListsMemberResponse,
  AddListsMemberError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AddListsMemberRequest,
  output: AddListsMemberResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "addListsMember",
}));

export type CreateListsError = XOpError;
/** Create Lists */
export const createLists: API.OperationMethod<
  CreateListsRequest,
  CreateListsResponse,
  CreateListsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateListsRequest,
  output: CreateListsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "createLists",
}));

export type DeleteListsError = XOpError;
/** Delete List Deletes a specific List owned by the authenticated user by its ID. */
export const deleteLists: API.OperationMethod<
  DeleteListsRequest,
  DeleteListsResponse,
  DeleteListsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DeleteListsRequest,
  output: DeleteListsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "deleteLists",
}));

export type GetListsByIdError = XOpError;
/** Get Lists by ID */
export const getListsById: API.OperationMethod<
  GetListsByIdRequest,
  GetListsByIdResponse,
  GetListsByIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetListsByIdRequest,
  output: GetListsByIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getListsById",
}));

export type GetListsFollowersError = XOpError;
/** Get Lists Followers */
export const getListsFollowers: API.OperationMethod<
  GetListsFollowersRequest,
  GetListsFollowersResponse,
  GetListsFollowersError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetListsFollowersRequest,
  output: GetListsFollowersResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getListsFollowers",
}));

export type GetListsMembersError = XOpError;
/** Get Lists Members */
export const getListsMembers: API.OperationMethod<
  GetListsMembersRequest,
  GetListsMembersResponse,
  GetListsMembersError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetListsMembersRequest,
  output: GetListsMembersResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getListsMembers",
}));

export type GetListsPostsError = XOpError;
/** Get Lists Posts */
export const getListsPosts: API.OperationMethod<
  GetListsPostsRequest,
  GetListsPostsResponse,
  GetListsPostsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetListsPostsRequest,
  output: GetListsPostsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getListsPosts",
}));

export type PinListError = XOpError;
/** Pin List Causes the authenticated user to pin a specific List by its ID. */
export const pinList: API.OperationMethod<
  PinListRequest,
  PinListResponse,
  PinListError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: PinListRequest,
  output: PinListResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "pinList",
}));

export type RemoveListsMemberByUserIdError = XOpError;
/** Remove a List member Removes a User from a List by their ID. */
export const removeListsMemberByUserId: API.OperationMethod<
  RemoveListsMemberByUserIdRequest,
  RemoveListsMemberByUserIdResponse,
  RemoveListsMemberByUserIdError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: RemoveListsMemberByUserIdRequest,
  output: RemoveListsMemberByUserIdResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "removeListsMemberByUserId",
}));

export type UnfollowListError = XOpError;
/** Unfollow a List Causes the authenticated user to unfollow a List by its ID. */
export const unfollowList: API.OperationMethod<
  UnfollowListRequest,
  UnfollowListResponse,
  UnfollowListError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UnfollowListRequest,
  output: UnfollowListResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "unfollowList",
}));

export type UnpinListError = XOpError;
/** Unpin a List Causes the authenticated user to unpin a List by its ID. */
export const unpinList: API.OperationMethod<
  UnpinListRequest,
  UnpinListResponse,
  UnpinListError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UnpinListRequest,
  output: UnpinListResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "unpinList",
}));

export type UpdateListsError = XOpError;
/** Update List Updates the details of a specific List owned by the authenticated user by its ID. */
export const updateLists: API.OperationMethod<
  UpdateListsRequest,
  UpdateListsResponse,
  UpdateListsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateListsRequest,
  output: UpdateListsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "updateLists",
}));
