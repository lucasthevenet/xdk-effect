...
export type GetTrendsPersonalizedTrendsError = XOpError;
/** Get Trends Personalized Trends */
export const getTrendsPersonalizedTrends: API.OperationMethod<
  GetTrendsPersonalizedTrendsRequest,
  GetTrendsPersonalizedTrendsResponse,
  GetTrendsPersonalizedTrendsError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetTrendsPersonalizedTrendsRequest,
  output: GetTrendsPersonalizedTrendsResponse,
  errors: [XParseError],
  protocol: XProtocol,
  retry: Retry.Retry,
  operationName: "getTrendsPersonalizedTrends",
}));
