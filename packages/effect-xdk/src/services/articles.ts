...
export type ArticleCreateDraftError = XOpError;
/** Create draft Article Creates a new Article draft that can later be published. */
export const articleCreateDraft: API.OperationMethod<
  ArticleCreateDraftRequest,
  ArticleCreateDraftResponse,
  ArticleCreateDraftError,
  XOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ArticleCreateDraftRequest,
  output: ArticleCreateDraftResponse,
  errors: [XParseError],
  protocol: XProtocol,
  operationName: "articleCreateDraft",
}));

export type ArticlePublishError = XOpError;
/** Publish Article Publishes a draft Article, making it publicly visible. */
export const articlePublish: API.OperationMethod<
