...
export const securitySymbol = Symbol.for("effect-xdk/security");
...
export const csvQuerySymbol = Symbol.for("effect-xdk/csv-query");
/** OpenAPI form query parameters with explode: false. */
export const CsvQuery = (enabled = true) =>
  makeAnnotation(csvQuerySymbol, enabled);

export const multipartSymbol = Symbol.for("effect-xdk/multipart");
...
export const requestBodySymbol = Symbol.for("effect-xdk/request-body");
...
export const responseSymbol = Symbol.for("effect-xdk/response");
